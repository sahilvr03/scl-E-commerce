...
export default function Footer() {
  return (
    <div className="bg-gray-800 dark:bg-gray-900 text-gray-300 dark:text-gray-400 border-t border-gray-700 dark:border-gray-800 py-12 z-[-10]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/shipping" className="hover:text-teal-400 transition-colors">Shipping Policy</Link></li>
              <li><Link href="/returns" className="hover:text-teal-400 transition-colors">Returns & Refunds</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-gray-200 dark:text-gray-100 uppercase tracking-wider mb-5">
            ...
            <ul className="space-y-3">
              <li><Link href="/about" className="hover:text-teal-400 transition-colors">Our Story</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/products" className="hover:text-teal-400 transition-colors">All Products</Link></li>
              <li><Link href="/featured" className="hover:text-teal-400 transition-colors">Featured</Link></li>
              <li><Link href="/new-arrivals" className="hover:text-teal-400 transition-colors">New Arrivals</Link></li>
              <li><Link href="/deals" className="hover:text-teal-400 transition-colors">Deals</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-gray-200 dark:text-gray-100 uppercase tracking-wider mb-5">

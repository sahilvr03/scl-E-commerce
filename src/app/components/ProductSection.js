...
export default function ProductSection({ title, items, loading, error, link, icon, bgColor, isSale = false, endDate }) {
        ...
        <div className="flex items-center mb-4 sm:mb-0">
          ...
          <div>
            ...
            {isSale && items.length > 0 && (
              <CountdownTimer endDate={endDate} className="text-sm text-gray-600" />
            )}
          </div>
        </div>
        <Link

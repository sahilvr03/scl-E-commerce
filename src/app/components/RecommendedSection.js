...
export default function RecommendedSection({ recommendedItems, categories, error }) {
  const [selectedCategory, setSelectedCategory] = useState('');
  const [filteredRecommended, setFilteredRecommended] = useState(recommendedItems);
  ...
  return (
    <section className="mb-12 bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl">
      ...
      {error && filteredRecommended.length === 0 ? (
        <motion.div
